      ...
      <>
        ...
        <div className="md:flex justify-center items-center">
          ...
          <Card className="flexw-[350px]">
            ...
            <CardContent>
              <Button asChild>
                <Link href="/system/student/subjects/japanese/second">
                  単元リストに進む
                </Link>
              </Button>
            </CardContent>
          ...
          <Card className="flexw-[350px]">
            ...
            <CardContent>
              <Button asChild>
                <Link href="/system/student/subjects/japanese/third">
                  単元リストに進む
                </Link>
              </Button>
            </CardContent>
      ...
      <>
        ...
        <div className="md:flex justify-center items-center">
          ...
          <Card className="flexw-[350px]">
            ...
            <CardContent>
              <Button asChild>
                <Link href="/system/student/subjects/math/second">
                  単元リストに進む
                </Link>
              </Button>
            </CardContent>
          ...
          <Card className="flexw-[350px]">
            ...
            <CardContent>
              <Button asChild>
                <Link href="/system/student/subjects/math/third">
                  単元リストに進む
                </Link>
              </Button>
            </CardContent>
    ...
    return (
      <>
        <Alert variant="destructive">
          ...
          <AlertDescription>教科パラメーターが不正です。</AlertDescription>
        </Alert>
      </>
    );
  }
